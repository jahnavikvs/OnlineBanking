...
@media screen and (max-width: 500px) {
	...
	<div class="container" style="margin-top: 0px">
				...
				<div class="collapse navbar-collapse " id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a
							...
							href="index.html"><i class="fa fa-fw fa-home"></i>Home<span
								class="sr-only">(current)</span></a></li>

						<li class="nav-item active"><a
							class="nav-link  text-uppercase font-weight-bold text-white"
							href="CustomerLogin.html"><i class="fa fa-fw fa-sign-out"></i>Logout</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<marquee BEHAVIOR=SCROLL direction="left" loop="30" scrollamount="5"
			...
			bgcolor="white">
			<font color="red"> Imporant ! Dear Customers donot share your
			...
			<div class="container">
				<div class="collapse navbar-collapse" id="navbarCollapse2">
					<div class="navbar-nav">
						<a href="#" class="nav-item nav-link text-white active"><span
							style="display: inline-block; width: 10px;"></span><span
							style="display: inline-block; width: 10px;"></span>Deals & More<span
							style="display: inline-block; width: 10px;"></span></a> <a href="#"
		...
		<div class="row">
			<span style="display: inline-block; width: 17px;"></span> <font
				style="background-color: #DEDEE4; height: 30px"> Last Login:
				23/12/2018</font> <span style="display: inline-block; width: 697px;"></span>
			<font style="background-color: #DEDEE4; height: 30px; width: 250px">
				Welcome Bhargavi Madapani</font>
		</div>
		<div class="row">
			<div class="col-sm-4">
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item"><a class="nav-link active"
						href="Profile.jsp"><i class="fa fa-fw fa-user-circle-o fa-lg"
			...
			<div class="col-sm-8">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="CustomerId"control-label">049580576</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="First Name"control-label">Bhargavi</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="Last Name"control-label">Madapani</label>
					</div>
				</div>
				<br />
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="Date Of Birth"control-label">27/03/2000</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="Phone Number"control-label">9876543210</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="Address Proof Type"control-label">Ration Card</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="Address Proof Number"control-label">343123ffwf4</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="AadharNumber"control-label">Ration Card</label>
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-sm-4">
						<label for="Email"control-label">bhargavimadapani@gmail.com</label>
					</div>
				</div>
				<br />
				<br />
