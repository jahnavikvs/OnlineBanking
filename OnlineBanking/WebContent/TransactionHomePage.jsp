...
Welcome <%=customer.getFirstName() + " " + customer.getLastName()%></font>
  ...
  <div class="row">
    <div class="col-sm-4">
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="TransactionHomePage.jsp"><i class="fa fa-fw fa-repeat fa-lg" aria-hidden="true"></i><b>Quick Transfer</b></a>
        </li>
        <li class="nav-item">
  ...
  <tr>
    ...
    <td><%=account.getBalance() %></td>
             ...
             <div class="container">
                <div class="row">
                    <label for="Beneficiary Name" class="col-sm-6 control-label">Beneficiary Name<font color="red">*</font></label>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <label for="Beneficiary AccNo" class="col-sm-6 control-label">Beneficiary Acc Number<font color="red">*</font></label>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <label for="Beneficiary AccNo" class="col-sm-6 control-label">Confirm Account Number<font color="red">*</font></label>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <label for="Amount" class="col-sm-6 control-label">Amount<font color="red">*</font></label>
                    <div class="col-sm-6">
