...
<title>Samridhi Customer Request Page</title>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link  bg-info active" href="RequestForAnother.jsp"><i class="fa fa-fw fa-group fa-lg" aria-hidden="true"></i><b>Request for another Account</b></a>
        </li>
        <li class="nav-item">
      ...
      <tr>
        ...
        <form action="RegisterCustomerServlet" method="post">
            ...
            <div class="form-check">
            	You Have <%= accounts.get(0).getAccountType()%> Account.
            	<% if(accounts.get(0).getAccountType().equalsIgnoreCase("Savings")) { session.setAttribute("accType", "Current");%>
            	Click here to request for Current account.</br>
            	<%} else { session.setAttribute("accType", "Savings");%>
            	Click here to request for Savings account.</br>
            	<%} %>
                 <button type="submit" class="btn btn-sm btn-success float-left" action="RequestServlet" method="post">Request</button>
            </div>
            <% } else {%>
            <div class="form-check">
                 <button type="button" disabled class="btn btn-sm btn-success float-left" action="RequestServlet" method="post">Request</button>
                 </br></br> You already have two Accounts</br>
            </div> 
            <%} %>
        </form>     
        </div>
